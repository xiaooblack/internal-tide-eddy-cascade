...
figure
set(gcf, 'unit', 'centimeters', 'position', [1 1 26 23.5]);% [left, bottom, width, height]
AH1 = axes('Parent', gcf, 'unit', 'centimeters', 'Position', [4.5 16.5 7.5 6]);
...
set(tit, 'unit', 'centimeters','Position', [2.9 6.1 0])
    
AH1b= axes('Parent', gcf, 'unit', 'centimeters', 'Position', [8.74 19.88 3.25 2.6]);
...
AH2 = axes('Parent', gcf, 'unit', 'centimeters', 'Position', [15 16.5 7.5 6]);
...
set(AH2,'layer','top');
hhh = colorbar;
set(hhh, 'unit', 'centimeters','Position', [23.5 17.5 0.4 4]);
title(hhh,'\zeta/\itf');
tit=title('\bf(b) \rm2-day Low-pass Ro (Notide)','fontsize',12,'fontname','Arial');
set(tit, 'unit', 'centimeters','Position', [3.1 6.1 0])

AH2b= axes('Parent', gcf, 'unit', 'centimeters', 'Position', [19.25 19.88 3.25 2.6]);
...
AH3 = axes('Parent', gcf, 'unit', 'centimeters', 'Position', [2 10 6 4.8]);
...
AH4 = axes('Parent', gcf, 'unit', 'centimeters', 'Position', [10.5 10 6 4.8]);
...
AH5 = axes('Parent', gcf, 'unit', 'centimeters', 'Position', [19 10 6 4.8]);
...
AH6 = axes('Parent', gcf, 'unit', 'centimeters', 'Position', [14.5 1.5 10 6]);
...
tit=title('\bf(g) \rmSpectral Energy flux','FontName', 'Arial','FontSize',13); 
set(tit, 'unit', 'centimeters','Position', [2.5 6.1 0])
ylim([-17 2])
xlim([1e-2 1]);
legend('show', 'Location', 'southeast','FontSize', 13);box on

AH7 = axes('Parent', gcf, 'unit', 'centimeters', 'Position', [2 1.5 10 6]);
...
set(gca, 'XScale', 'log');set(gca,'linewidth', 1)
set(gca,'FontName', 'Arial','FontSize',12)
tit=title('\bf(f) \rmSpectral Enstrophy flux','FontName', 'Arial','FontSize',13); 
set(tit, 'unit', 'centimeters','Position', [2.85 6.1 0])
ylim([-0.5 10])
xlim([1e-2 1]);
legend('show', 'Location', 'southeast','FontSize', 13);box on

print(gcf, 'D:\学花招的素材\初稿\wave-flow interation influence flow energy cascade\figure\Fig 2 GRL.tiff', '-dtiff', '-r600')   % TIFF, 600 dpi