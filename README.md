...
This folder contains the plotting scripts used to generate the figures in the paper. The GRL manuscript contains four main-text figures: `figure_1.m` generates Figure 1, `figure_2.m` generates the combined Figure 2 (former Figures 2 and 3), and `figure_3.m` generates Figure 3 (former Figure 4). Figure 4 is a conceptual schematic and is not generated by a MATLAB plotting script.

Files named `figure_s*.m` generate the Supporting Information figures and retain their existing numbering.
